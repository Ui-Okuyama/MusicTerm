...
struct Comment {
    ...
    let commentData = [
        ...
        "Beethoven" : ["自らの力で自らを切り開け","苦悩を突き抜ければ喜びを勝ち得る","どんな難問だろうと打ち勝ってみせよう","誰も君の努力を邪魔することはできない","ここまできたか…！","これほど嬉しいことがあるだろうか！"],
        "Bach" : ["勉強して出直してこい！","勤勉でいれば、上手くいく。","誰でも努力すれば私ほどになれるんだ！","どんな難問でも解けなければならない","神は私たちの努力を見守ってくださっている","よくここまでやってきた！！"],
        ...
        "Brahms" : ["君には努力する才能が必要だな","少しはマシなぐらいだ","これくらいで油断するんじゃない","…まあまあだな","…まあいいじゃないか","素晴らしい…！"],
        "Schumann" : ["ひどい有様だ…！","まだまだだな…","こんなものでは通用しない…","なんとか基本はできるようになったな","ドイツ語は美しい言葉が多い。覚えてくれ！","素晴らしい！天才的だ！"],
        ...
        "Liszt" : ["君はきっと、やればできるよ","その調子！一生懸命な君は素敵だ","今晩僕の家で勉強していかないか","すごいじゃないか！","素晴らしいな、頑張る君の姿は美しい","君は最高だ！"],
